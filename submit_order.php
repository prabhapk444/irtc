...
$stmt = $conn->prepare("INSERT INTO orders (user_id, name, email, phone, train_no, station, total_price, created_at) VALUES (?, ?, ?, ?, ?, ?, ?, NOW())");
$stmt->bind_param("isssssd", $user_id, $name, $email, $phone, $train_no, $station, $total_price);
$stmt->execute();
